...
exports.createEvento = async (req, res) => {
    const { image, name_evento, fecha, tiempo, location, descripcion, id_zoologico } = req.body;
    try {
        const newEvento = await eventoModel.eventos.create(image, name_evento, fecha, tiempo, location, descripcion, id_zoologico);
